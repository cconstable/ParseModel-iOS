...
static inline void setIdProperty(ParseModel *self, NSString* property, id value) {
...
#if USE_BLOCKS
    return imp_implementationWithBlock(^id(ParseModel* receiver) {
...
#if USE_BLOCKS
    return imp_implementationWithBlock(^(ParseModel* receiver, id value) {
...
+ (IMP) impForGetterOfProperty: (NSString*)property ofType: (const char*)propertyType {
    switch (propertyType[0]) {
        ...
        case _C_UCHR:
#if USE_BLOCKS
            return imp_implementationWithBlock(^int(ParseModel* receiver) {
        ...
        case _C_BOOL:
#if USE_BLOCKS
            return imp_implementationWithBlock(^bool(ParseModel* receiver) {
        ...
        case _C_DBL:
#if USE_BLOCKS
            return imp_implementationWithBlock(^double(ParseModel* receiver) {
...
+ (IMP) impForSetterOfProperty: (NSString*)property ofType: (const char*)propertyType {
    switch (propertyType[0]) {
        ...
        case _C_UCHR:
#if USE_BLOCKS
            return imp_implementationWithBlock(^(ParseModel* receiver, int value) {
...
#if USE_BLOCKS
            return imp_implementationWithBlock(^(ParseModel* receiver, bool value) {
        ...
        case _C_DBL:
#if USE_BLOCKS
            return imp_implementationWithBlock(^(ParseModel* receiver, double value) {
